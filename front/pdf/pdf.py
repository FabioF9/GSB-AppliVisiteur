def CreerPresentation(id_rapport,headers):
    ...
    medecin_query       = requests.get('http://192.168.1.119:8000/medecin/'+rapport_infos['MED_ID'],headers=headers)
    ...
    medicament1_query   = requests.get('http://192.168.1.119:8000/medicament/'+rapport_echantillon[0]['MEDI_ID'],headers=headers)
    rapport_medicament1 = medicament1_query.json()
    medicament2_query   = requests.get('http://192.168.1.119:8000/medicament/'+rapport_echantillon[1]['MEDI_ID'],headers=headers)
